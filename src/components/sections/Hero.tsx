      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="gradient-text text-glow">That Drive Growth</span>
          </motion.h1>
          ...
          >
            Full-service digital agency specializing in marketing, web & app development, 
            and custom software solutions that transform your business.
          </motion.p>
